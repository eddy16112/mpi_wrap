...
namespace IMPL {
    ...
    : mpi_so_handle(mpi_so_handle)
  {
    ...
    IMPL_Comm_split = reinterpret_cast<int (*)(MPI_Comm, int, int, MPI_Comm *)>(WRAP_DLSYM(mpi_so_handle, "MPI_Comm_split"));
    IMPL_Comm_split_type = reinterpret_cast<int (*)(MPI_Comm, int, int, MPI_Info, MPI_Comm *)>(WRAP_DLSYM(mpi_so_handle, "MPI_Comm_split_type"));
    ...
    IMPL_Allgatherv = reinterpret_cast<int (*)(const void *, int, MPI_Datatype, void *, const int[], const int[], MPI_Datatype, MPI_Comm)>(WRAP_DLSYM(mpi_so_handle, "MPI_Allgatherv"));
    ...
    IMPL_Alltoall = reinterpret_cast<int (*)(const void *, int, MPI_Datatype, void *, int, MPI_Datatype, MPI_Comm)>(WRAP_DLSYM(mpi_so_handle, "MPI_Alltoall"));
    ...
    IMPL_Gather = reinterpret_cast<int (*)(const void *, int, MPI_Datatype, void *, int, MPI_Datatype, int, MPI_Comm)>(WRAP_DLSYM(mpi_so_handle, "MPI_Gather"));
